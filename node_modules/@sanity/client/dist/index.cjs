...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  } : _stega, params = stega.enabled ? vercelStegaCleanAll.vercelStegaCleanAll(_params) : _params, mapResponse = options.filterResponse === !1 ? (res) => res : (res) => res.result, { cache, next, ...opts } = {
